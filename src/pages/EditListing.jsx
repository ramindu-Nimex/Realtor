...
export default function EditListing() {
   ...
   async function onSubmit(e) {
      ...
      if(images.length > 6) {
         setLoading(false)
         return toast.error("Maximum 6 Images are allowed") 
      }
      let geolocation = {}
      let location
         ...
         {!geolocationEnabled && (
            <div className='flex items-center mb-6 space-x-6'>
               <div className="">
                  ...
                  <input type="number" id='latitude' value={latitude} onChange={onChange} min="-90" max="90" required className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center' />
               </div>
               <div className="">
                  <p className='text-lg font-semibold'>Longitude</p>
                  <input type="number" id='longitude' value={longitude} onChange={onChange} min="-180" max="180" required className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center' />
               </div>
            </div>
         )}
